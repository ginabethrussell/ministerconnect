    ...
    <div className="min-h-screen bg-gray-100 p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <section className="bg-white rounded-lg shadow-md">
          {loading ? (
            <div className="text-center py-20"><p>Loading codes...</p></div>
          ) : codes.length === 0 ? (
                        ...
                        <tr key={code.id}>
                          ...
                          <td className="py-4 px-6">
                            {isEditing ? (
                              <input
                                ...
                                onChange={e => setEditValues(v => ({ ...v, event: e.target.value }))}
                              />
                            ) : (
                          ...
                          <td className="py-4 px-6 text-center">
                            <div className="flex justify-center gap-2">
                              {isEditing ? (
                                <>
                                  <button onClick={() => saveEdit(code.id)} className="btn-primary-sm">Save</button>
                                  <button onClick={cancelEdit} className="btn-secondary-sm">Cancel</button>
                                </>
                              ) : (
                                <>
                                  <button onClick={() => startEdit(code)} className="btn-secondary-sm">Edit</button>
                                  <button onClick={() => handleDelete(code.id)} className="btn-danger-sm">Delete</button>
                                </>
                              )}
                            </div>
                          </td>
