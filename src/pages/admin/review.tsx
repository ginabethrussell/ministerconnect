          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
              {filteredProfiles.map((profile, idx) => {
                ...
                return (
                  <div key={`${fullName}-${idx}`} className="rounded-lg bg-white p-6 shadow-md">
                    <div className="mb-4 flex items-start gap-4">
                      {profile.profile_image ? (
                        <img
                          src={profile.profile_image}
                          alt={`${fullName}`}
                          className="shadow-xlg h-16 w-16 rounded-lg border-2 border-gray-300 object-cover"
                        />
                      ) : (
                        <div className="shadow-xlg rounded-full border-2 border-gray-300 object-cover">
                          <UserIcon />
                        </div>
                      )}
                    ...
                    <div className="mb-6 rounded-lg bg-gray-50 p-4">
                      <h4 className="mb-3 font-semibold text-gray-800">Contact Information</h4>
                      <div className="space-y-2 text-sm">
                        ...
                        <div className="flex items-center gap-2">
                          <span className="w-20 font-medium text-gray-600">Location:</span>
                    ...
                    <div className="mb-6 rounded-lg bg-gray-50 p-4">
                      <h4 className="mb-3 font-semibold text-gray-800">Documents & Media</h4>
                      <div className="space-y-2">
                        {profile.resume && (
                          <div className="flex items-center gap-4 text-sm">
                            <span className="w-16 font-medium text-gray-600">Resume:</span>
                            <a
                              href={profile.resume}
                              target="_blank"
                        ...
                        {profile.video_url && (
                          <div className="flex items-center gap-4 text-sm">
                            <span className="w-16 font-medium text-gray-600">Video:</span>
                            <a
                    ...
                    {profile.placement_preferences && profile.placement_preferences.length > 0 && (
                      <div className="mb-6">
                        <h4 className="mb-2 font-semibold text-gray-800">Placement Preferences</h4>
                    ...
                    {profile.status !== 'approved' && profile.status !== 'rejected' && (
                      <div className="flex gap-2 border-t border-gray-200 pt-4">
                        <button
                          ...
                          className="flex-1 rounded bg-blue-600 px-4 py-2 text-white transition-colors hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50"
                        >
                        ...
                        <button
                          ...
                          disabled={actionLoadingId === profile.id.toString()}
                          className="flex-1 rounded bg-red-600 px-4 py-2 text-white transition-colors hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 disabled:opacity-50"
                        >
